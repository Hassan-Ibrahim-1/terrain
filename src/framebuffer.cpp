...
const std::array<uint, MAX_COLOR_ATTACHMENTS>& Framebuffer::get_color_attachments() {
    return _color_attachments;
}

const std::array<uint, MAX_RENDERBUFFER_ATTACHMENTS>& Framebuffer::get_rbo_attachments() {
    return _render_buffer_attachments;
}

uint Framebuffer::get_color_attachment_by_index(size_t index) {
    ASSERT(index < color_attachments_count(), "index is greater than the number of color attachments");
    return _color_attachments[index];
}

uint Framebuffer::get_rbo_attachment_by_index(size_t index) {
    ASSERT(index < rbo_attachments_count(), "index is greater than the number of renderbuffer attachments");
