...
Window::Window(uint width, uint height, const std::string& title, bool enable_msaa)
...
void Window::load_opengl_functions() {
    ASSERT(gladLoadGLLoader((GLADloadproc)glfwGetProcAddress), "Bad glad initialization");
}
